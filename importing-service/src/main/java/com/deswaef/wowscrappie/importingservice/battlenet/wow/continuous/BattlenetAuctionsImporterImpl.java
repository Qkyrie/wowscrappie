...
import com.deswaef.wowscrappie.importingservice.battlenet.wow.AuctionFetcher;
import com.deswaef.wowscrappie.importingservice.battlenet.wow.auctions.client.domain.AuctionItem;
import com.deswaef.wowscrappie.importingservice.battlenet.wow.auctions.client.domain.AuctionResponse;
...
import com.deswaef.wowscrappie.importingservice.wowhead.client.ItemFetchingService;
        ...
        realms
                .forEach(realm -> auctionItemRepository
                        .save(
                                auctions
                                        .parallelStream()
                                        .map(auction -> AuctionItem.convert.apply(auction))
