...
import com.deswaef.wowscrappie.ui.macros.repository.BossMacroRepository;
import com.deswaef.wowscrappie.ui.macros.repository.MacroRepository;
import com.deswaef.wowscrappie.ui.macros.repository.SpecMacroRepository;
import com.deswaef.wowscrappie.ui.macros.repository.WowClassMacroRepository;
...
public class MacroServiceImpl implements MacroService {
    ...
    public void edit(EditConfigurationDto dto) {
        if (StringUtils.isEmpty(dto.getActualValue())) {
            throw new IllegalArgumentException("actual value cannot be empty");
        } else if (StringUtils.isEmpty(dto.getCaption())) {
