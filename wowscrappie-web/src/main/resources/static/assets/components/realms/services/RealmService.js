System.register(['rxjs/add/operator/map', 'rxjs/add/operator/filter', 'rxjs/add/operator/catch', 'angular2/core', 'angular2/http', '../entity/Realm'], function(exports_1, context_1) {
    "use strict";
